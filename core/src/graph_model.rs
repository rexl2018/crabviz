...
impl GraphBuilder {
    ...
    pub fn add_file(&mut self, path: String, symbols: Vec<crate::types::lsp::DocumentSymbol>) -> u32 {
    ...
    fn convert_symbols(&self, file_id: u32, symbols: &[crate::types::lsp::DocumentSymbol]) -> Vec<Symbol> {
